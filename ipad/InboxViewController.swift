//
//  InboxViewControllerController.swift
//  memuDemo
//
...
class InboxViewController: UIViewController,UINavigationBarDelegate,UINavigationControllerDelegate, GIDSignInUIDelegate, GIDSignInDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func CheckSpeak(){
        ...
        if self.speaker.synth.isSpeaking {
            ...
            timer = Timer.scheduledTimer(timeInterval: 5.0, target: self, selector: #selector(InboxViewController.update), userInfo: nil, repeats: true)
        }
    }
